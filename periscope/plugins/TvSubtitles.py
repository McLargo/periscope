            ...
            for img in imgs:
                ...
                if img["alt"] and ((langs and img["alt"] in langs) or (not langs)):
                    ...
                    if url.startswith("subtitle"):
                        ...
                        sub = self.parseSubtitlePage(
                            url, lang, show, season, episode, teams
                        )
                        if sub:
                            links.append(sub)
                    else:
    ...
    def parseSubtitlePage(self, url, lang, show, season, episode, teams):
        ...
        if releases:
            subteams.update(
                [
                    releases[0]
                    .parent.parent.parent.parent.findAll("td")[2]
                    .string.lower()
                ]
            )
        ...
        if rips:
            subteams.update(
                [rips[0].parent.parent.parent.parent.findAll("td")[2].string.lower()]
            )
